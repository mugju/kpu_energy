	...
	var chartDrowFun = {
		...
		chartDrow : function() {
			...
			function drawDashboard() {
				...
				data.addColumn('number', '평소 사용 전력');
				data.addColumn('number','절감한 전력');
				data.addColumn('number','손님수');

				var dateArray = new Array();
				var ampArray = new Array();
				var ampArray2 = new Array();
				...
				<c:forEach items = "${env}" var = "vo2">
				ampArray2.push("${vo2.people}");
				</c:forEach>
				...
				for (var i = 0; i <dateArray.length; i++) { //랜덤 데이터 생성
					...
					var people=parseInt(ampArray2[i]);
					var subAmp=-1;
					if(people==0){
						subAmp=0;
					}else{
