...
//#define WIFI_PASS "1803003041" //이거 바꿔

//재현이형꺼
//#define WIFI_SSID "AndroidHotspot1283"
//#define WIFI_PASS "j1234567" //이거 바꿔
...
AdafruitIO_Feed *E421 = io.feed("E421"); //듀얼피드 확인용
void setup() {
...
void loop() {
  ...
  E421->onMessage(handleMessage); //메시지 수신했음 //여기피드도 숫자로 조져야함
...
void handleMessage(AdafruitIO_Data *data) {
  ...
  if (state == 11) {
    Serial.println("Radio ON"); //421켜졌을때
    IrSender.sendNEC(0xFFA25D,32);
  }
  if (state == 12) {
    Serial.println("Radio OFF"); //421켜졌을때
    IrSender.sendNEC(0xFFA25D,32);
  }
