...
class ButtonZooming5_1 extends SampleView {
  /// Creates the chart with custom zooming buttons.
  const ButtonZooming5_1(Key key) : super(key: key);

  @override
  _ButtonZooming5_1State createState() => _ButtonZooming5_1State();
}

/// State class of the chart with custom zooming buttons.
class _ButtonZooming5_1State extends SampleViewState {
  _ButtonZooming5_1State();
