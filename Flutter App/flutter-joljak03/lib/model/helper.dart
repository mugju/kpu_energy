              ...
              Stack(children: <Widget>[
                if (_model.themeData.brightness == Brightness.light)
                  Container(
                    ...
                    child: Image.asset('images/energy_manager_menu.png',
                        fit: BoxFit.cover),
                  )
                else
                  Container(
                    padding: const EdgeInsets.fromLTRB(10, 30, 30, 0),
                    child: Image.asset('images/energy_manager_menu_dark.png',
                        fit: BoxFit.cover),
                  )
                            ...
                            child: Material(
                                ...
                                child: InkWell(
                                    ...
                                    onTap: () {
                                      Feedback.forLongPress(context);
                                      launch(
                                          'https://github.com/mugju/kpu_energy');
                                    },
                                    child: Padding(
                                        padding: const EdgeInsets.fromLTRB(
                                            25, 0, 0, 0),
