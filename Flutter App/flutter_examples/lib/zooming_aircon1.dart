...
class AirConditioner1 extends SampleView {
  /// Creates the chart with custom zooming buttons.
  const AirConditioner1(Key key) : super(key: key);

  @override
  _AirConditioner1State createState() => _AirConditioner1State();
}

/// State class of the chart with custom zooming buttons.
class _AirConditioner1State extends SampleViewState {
  _AirConditioner1State();
