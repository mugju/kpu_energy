...
class ButtonZooming1_1 extends SampleView {
  /// Creates the chart with custom zooming buttons.
  const ButtonZooming1_1(Key key) : super(key: key);

  @override
  _ButtonZooming1_1State createState() => _ButtonZooming1_1State();
}

/// State class of the chart with custom zooming buttons.
class _ButtonZooming1_1State extends SampleViewState {
  _ButtonZooming1_1State();
